...
class PdfInvoiceServiceforAk {
  ...
  final String pochkiCHLS;
  final String pochkiVal;
  final DateTime perviyDengPMS;
  final WidgetRef ref;

  PdfInvoiceServiceforAk({
    required this.ref,
    required this.pochkiCHLS,
    required this.pochkiVal,
...
/*   double get obyom1 {
  ...
  double get obyom2 {
    ...
    return (number * 0.52).floorToDouble();
  }
  ...
  Future<void> createAndOpenPdf() async {
            ...
            child: pw.Column(
              children: [
                    ...
                    child: pw.Container(
                      child: pw.Column(children: [
                        pw.Container(
                            ...
                            child: pw.Column(children: [
                              ...
                              pw.Row(
                                ...
                                children: [
                                  pw.Text('СВД: $svd mm', style: defaultFont),
                                  pw.Text('КТР: $ktr mm', style: defaultFont),
                                  pw.Text('ТВП: $tvp mm', style: defaultFont),
                                  pw.Text('НК: $nk mm', style: defaultFont),
                                ],
                              ),
                            ])),
                        pw.SizedBox(height: 10),
                        ...
                        pw.Container(
                            ...
                            child: pw.Column(children: [
                              pw.Center(
                                child: pw.Text('Почки', style: defaultBoldfont),
                              ),
                              pw.SizedBox(height: 5),
                              pw.Row(
                                mainAxisAlignment:
                                ...
                                children: [
                                  pw.Row(children: [
                                    pw.Text('ЧЛС: ', style: defaultBoldfont),
                                    pw.Text(pochkiCHLS, style: defaultFont),
                                  ]),
                                  pw.Row(children: [
                                    pw.Text('Состояния: ',
                                        style: defaultBoldfont),
                                    pw.Text(pochkiVal, style: defaultFont),
                                  ]),
                                ],
                              ),
                            ])),
                        ...
                        pw.Container(
                            ...
                            child: pw.Column(children: [
                              pw.Row(children: [
                                ...
                                pw.Text('Срок беременности: ',
                                    style: defaultBoldfont),
                                pw.SizedBox(width: 50),
                                pw.Text('6 недель', style: defaultFont),
                                pw.SizedBox(width: 30),
                              ]),
                              pw.Row(children: [
                                pw.SizedBox(width: 30),
                                pw.Text('Дата родов: ', style: defaultBoldfont),
                                pw.SizedBox(width: 97),
                                pw.Text('07.11.2024', style: defaultFont),
                                pw.SizedBox(width: 30),
                              ]),
                            ])),
                        pw.SizedBox(height: 10),
                ...
                pw.Container(
                  ...
                  child: pw.Text('$vivod. $dopolnenie ',
    ...
    await file.writeAsBytes(await pdf.save());
    analyses = Analyses(
        cost: ref.watch(moneyProvider)['akushersvto']!,
        type: 'Акушерство',
        name: '${patient.surName}${patient.name}/akushersvto/$datetime.pdf',
        path: file.path,
