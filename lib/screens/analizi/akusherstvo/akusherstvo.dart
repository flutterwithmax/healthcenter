...
import 'package:test3/screens/analizi/akusherstvo/pdf_generator.dart';
          ...
          child: Column(children: [
            ...
            Row(
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    final pdfService = PdfInvoiceServiceforAk(
                      ref: ref,
                      pochkiCHLS: pochkiChlsVal,
                      pochkiVal: pochkiVal,
                      svd: svdController.text,
                      ktr: ktrController.text,
                      nk: nQController.text,
                      tvp: tvpController.text,
                      ...
                      data: {
                        ...
                        'В полости': vPolostiVal,
                        'Желточный мешок':
                            indexOfJeltochniyMeshok == 0 ? 'Нет' : 'Да',
                        'Сердцебиение': indefOfHeartBeat == 0 ? 'Нет' : 'Да',
                        'Движения': indexOfMovement == 0 ? 'Нет' : 'Да',
                        'Хорион': xorionVal,
                        'Гипертонус миометрий':
                            indexOfmiometriy == 0 ? 'Нет' : 'Да',
                        'Гемотома': gemotomaVal,
                        'Структура-Миометрия': structuraMiometriyVal,
                        ''
                            'Слизистая': slizistaya,
                        'Околоплодные воды': okoloPlodnieVal,
                        'Яичники справо':
                            '$yaichnikisPravo ${eggsRighController.text} мм',
                        'Яичники слево':
                            '$yaichnikisLevo ${egssLeftController.text} мм',
                      },
                      vivod: vivod,
                    );
